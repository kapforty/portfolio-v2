...
function Footer() {
  ...
  return (
    <div className="flex flex-col items-center w-screen bg-black">
      <div className="flex flex-col justify-end max-w-[2560px] w-full flex flex-col px-7 py-7">
        <div className="grid grid-cols-4 lg:grid-cols-12 gap-7 text-white">
          <div className="order-1 bg-neutral-900 col-span-4 rounded-2xl h-20">
            <div className="flex flex-col h-20 text-white font-bold text-lg justify-center items-center opacity-30">{formattedTime}</div>
          </div>
          <div className="order-last lg:order-2 bg-neutral-900 col-span-4 rounded-2xl h-20">
            <div className="flex items-center justify-evenly h-20">
              <a href="https://www.linkedin.com/in/jordanperanginangin/" target="_blank" rel="noopener noreferrer">
                <FaLinkedin className="h-6 w-6 opacity-30 hover:opacity-100 transition ease-in-out duration-150"/>
              </a>
              <a href="https://github.com/kapforty" target="_blank" rel="noopener noreferrer">
                <FaGithub className="h-6 w-6 opacity-30 hover:opacity-100 transition ease-in-out duration-150"/>
              </a>
              <a href="https://twitter.com/kapforty" target="_blank" rel="noopener noreferrer">
          ...
          <div className="order-3 bg-neutral-900 col-span-4 rounded-2xl h-20">
            <div className="flex flex-col h-20 text-white font-bold text-lg justify-center items-center opacity-30">JORDANANGIN@GMAIL.COM</div>
          </div>
        </div>
      </div>
    </div>
